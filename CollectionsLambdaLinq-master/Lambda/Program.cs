...
namespace Lambda
{
    class Program
    {
        private static void DelegateExample()
        {
            ...
            //@
            NumberCheck checkEven = SpecialFunctions.EvenNbFunction;
            ...
            //@
            IEnumerable<int> evenNumbers = SpecialFunctions.GetEvenNumbers(checkEven, numbersList);
        ...
        private static void FuncDelegateExample()
        {
             ...
             */
          //@
            foreach (int number in SpecialFunctions.GetOddNumbers(SpecialFunctions.OddNbFunction, numbersList))
                Console.WriteLine(number);
        ...
        private static void AnonymousFunctExample()
        {
             ...
             */
             //@ functie anonima:
            Func<int, bool> OddCheck = delegate (int var1)
            {
                return var1 % 2 != 0;

            };
            var result = SpecialFunctions.GetOddNumbers(OddCheck, numbersList);
